...
class Transform_Spark_Const:
	...
	create_tivo_resolved_table = '''
		...
		SELECT 
			...
			(unix_timestamp(t1.start_event_timestamp_local)-CAST(t1.recording_offset_seconds AS BIGINT)- (3600*(t1.utc_offset+5.0)) AS start_event_timestamp_match_with_offset,
			(unix_timestamp(t1.end_event_timestamp_local)-CAST(t1.recording_offset_seconds AS BIGINT) - (3600*(t1.utc_offset+5.0))  AS end_event_timestamp_match_with_offset
