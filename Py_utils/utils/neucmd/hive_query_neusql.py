...
class TestSuite(unittest.TestCase):
    ...
    def test_get_dbs_df(self):
        data = NeuSQL.hive_query(query='SHOW DATABASES;')
    ...
    def test_merge(self):
        ...
        data = NeuSQL.hive_query(query='SELECT t1.id, t1.name, t2.age FROM hq_test.table1 t1 JOIN hq_test.table2 t2 ON t1.id=t2.id;')
